...
const NotFoundPage = () => (
  ...
  <div className='container'>
    ...
    <p>Working closely with product and engineering teams makes Xuan a efficient collaborator and communicator. Xuan guides product teams to identify and apply reusable patterns and create products with consistency. Xuan also partners with engineering teams through documentation, office hours, and code reviews to ensure the parity between design and development.</p>
    <p>You are still there and want to know more? Feel free to check Xuan’s <a href='https://drive.google.com/file/d/1eTQO5ls8TMGJsOGg3l1oIxATCj1_HU89/view'>resume</a> or <a href='mailto:xuanliux93@gmail.com'>drop a line</a>.</p>
