...
const About = () => (
  ...
  <div className='container'>
    ...
    <p>While typical Product Designers spend days making visually appealing crafts, Xuan, as a System Designer, reviews design from the technical lens, systematizes designs with engineering patterns, and builds scalable, component-based design systems to facilitate design and development process.</p>
