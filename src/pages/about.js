    ...
    <div className='about'>
      ...
      <div className='profile-body'>
        <div className='profile-text'>
          ...
          <br/>
          <p>Outside work, you can find Xuan busy in cooking or hiking. Xuan also runs a <a href='https://meowshiba.com'>blog</a> (writtrn in chinese) with her partner, documenting their outdoor travel expereinces.</p>
        </div>
