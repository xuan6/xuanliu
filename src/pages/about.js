  ...
  <div className='container'>
    <div className='about'>
      <div className='profile-header'>
        ...
        <p>xuanliux93 [at] gmail [dot] com<br/> <a href='https://drive.google.com/file/d/1PeU2fxZq1E29kxCxy1LNf7nYjx80sQFx/view?usp=sharing'>resume</a></p>
      </div>
      <div className='profile-body'>
        <div className='profile-text'>
          ...
          <br/>
          <p>Outside of work, you can find Xuan busy in cooking, hiking, or practicing Kendo 剣道. Xuan also runs a <a href='https://meowshiba.com'>blog</a> (writtrn in Chinese) with her partner, documenting their outdoor travel experiences.</p>
        </div>
