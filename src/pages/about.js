...
const NotFoundPage = () => (
  ...
  <div className='container'>
    ...
    <p>Working closely with product and engineering teams makes Xuan a efficient collaborator and communicator. Xuan guides product teams to apply reusable patterns and create products with consistency. Xuan also partners with engineering teams through documentation, office hours, and code reviews to drive alignment and front-end fit and finish.</p>
    <p>Still wants to know more? Check Xuan’s <a href='https://drive.google.com/file/d/1eTQO5ls8TMGJsOGg3l1oIxATCj1_HU89/view'>resume</a> for details or <a href='mailto:xuanliux93@gmail.com'>drop a line</a>. </p>
